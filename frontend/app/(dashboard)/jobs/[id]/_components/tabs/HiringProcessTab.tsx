                  ...
                  {editingStageId === stage.id ? (
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <button
                        ...
                        className="h-8 cursor-pointer rounded-md bg-[var(--theme-color)] px-3 text-xs font-medium text-[#121212] hover:bg-[var(--theme-color-hover)] disabled:cursor-not-allowed disabled:opacity-50"
                      >
