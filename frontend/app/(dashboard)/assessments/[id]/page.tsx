      ...
      <div className="px-8 py-5 border-b border-slate-100 dark:border-neutral-800 flex items-center justify-between shrink-0 gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          {isManager ? (
            <>
              <Button
                className="h-9 gap-2 rounded-md border-none px-4 text-sm font-medium text-[#121212] shadow-none transition-all active:scale-[0.98] disabled:opacity-70 cursor-pointer"
