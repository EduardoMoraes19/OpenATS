...
export const integrationConnectButtonClassName =
  "inline-flex h-8 w-full cursor-pointer items-center justify-center rounded-md border-none bg-[var(--theme-color)] text-sm font-medium text-[#121212] shadow-none transition-colors hover:bg-[var(--theme-color-hover)] disabled:cursor-not-allowed disabled:opacity-60";
