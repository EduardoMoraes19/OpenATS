      ...
      <DialogContent className="max-w-lg rounded-2xl border-slate-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 shadow-xl p-0 overflow-hidden">
        ...
        <DialogFooter className="px-6 pb-6 pt-0 gap-2">
          ...
          <Button
            onClick={onSave}
            disabled={isPending}
            className="h-9 cursor-pointer gap-2 rounded-md border-none bg-[var(--theme-color)] px-4 text-sm font-medium text-[#121212] shadow-none transition-colors hover:bg-[var(--theme-color-hover)] disabled:opacity-60"
          >
