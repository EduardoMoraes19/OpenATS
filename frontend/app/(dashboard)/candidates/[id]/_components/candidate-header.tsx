            ...
            {hasStageChange && (
              <>
                ...
                <Button
                  ...
                  className="h-8 cursor-pointer gap-2 rounded-md border-none bg-[var(--theme-color)] px-3 text-sm font-medium text-[#121212] shadow-none hover:bg-[var(--theme-color-hover)]"
                >
